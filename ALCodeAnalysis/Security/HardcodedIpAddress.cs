...
{
    [DiagnosticAnalyzer]
    class HardcodedIpAddress : DiagnosticAnalyzer
    {
        ...
        public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics { get; } = ImmutableArray.Create<DiagnosticDescriptor>(
            DiagnosticDescriptors.Rule018HardcodedIpAddress);
        ...
        private static void ReportHardcodedIpAddress(
           SyntaxNodeAnalysisContext syntaxNodeAnalysisContext,
           Location location,
           string valueText)
        {
            syntaxNodeAnalysisContext.ReportDiagnostic(Diagnostic.Create(DiagnosticDescriptors.Rule018HardcodedIpAddress, location, (object)valueText));
        }
    }
}
